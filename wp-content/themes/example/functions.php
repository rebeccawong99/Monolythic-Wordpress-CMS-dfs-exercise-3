...
function example_scripts() {
	wp_enqueue_style( 'example-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'example-style', 'rtl', 'replace' );

	wp_enqueue_script( 'example-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
